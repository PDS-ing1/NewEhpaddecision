...
public class SensorPlan  implements ActionListener, WindowListener {
	...
	void initialize2() {
		...
		frame.getContentPane().add(livingRoom);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				setUp.getFrame().setVisible(true);
				frame.dispose();
		...
		frame.getContentPane().add(corridorr1);
		...
		frame.getContentPane().add(corridorr3);
		...
		frame.getContentPane().add(corridorr4);
		...
		frame.getContentPane().add(corridorr2);
		...
		frame.getContentPane().add(libraryy);
		...
		frame.getContentPane().add(dinningRoom);
		...
		frame.getContentPane().add(kitchenn);
