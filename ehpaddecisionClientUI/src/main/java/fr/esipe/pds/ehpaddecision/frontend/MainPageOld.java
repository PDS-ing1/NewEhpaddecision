	...
	public class MainPageOld extends JFrame {
		...
		public static void main(String[] args) {
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						MainPageOld frame = new MainPageOld();
		...
		public MainPageOld() {
			...
			//lblNewLabel.setIcon(new ImageIcon(MainPage.class.getResource("/client/iot.jpg")));
			...
			panel.setFocusTraversalPolicy(new FocusTraversalOnArrayOld());
		}
	}
