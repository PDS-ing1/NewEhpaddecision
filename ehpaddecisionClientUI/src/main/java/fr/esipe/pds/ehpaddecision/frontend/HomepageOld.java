...
public class HomepageOld extends JFrame {
	...
	private AlarmpageOld alarm = new AlarmpageOld();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HomepageOld frame = new HomepageOld();
	...
	public HomepageOld() {
		...
		lblNewLabel.setIcon(new ImageIcon(HomepageOld.class.getResource("/client/iot.jpg")));
		...
		panel.setFocusTraversalPolicy(new FocusTraversalOnArrayOld(new Component[]{txtAuthentification}));
	}
}
